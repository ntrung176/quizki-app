...
import { doc, setDoc, addDoc, onSnapshot, collection, query, updateDoc, serverTimestamp, deleteDoc, getDoc, getDocs, writeBatch, increment, collectionGroup, where, orderBy, limit } from 'firebase/firestore'
...
// Import screens
import { HomeScreen, LoginScreen, AccountScreen, HelpScreen, ImportScreen, StatsScreen, ListView, ReviewScreen, ReviewCompleteScreen, StudyScreen, TestScreen, FlashcardScreen } from './components/screens'
        ...
        const unsubscribe = onSnapshot(q, (snapshot) => {
            ...
            snapshot.forEach((doc) => {
                ...
                cards.push({
                    ...
                    pitch: data.pitch !== undefined ? data.pitch : null,
...
- "noun/adj-na" (nếu là danh từ kiêm tính từ đuôi -na)
    ...
    return (
        <div className="min-h-screen bg-transparent font-sans selection:bg-indigo-100 dark:selection:bg-indigo-900 selection:text-indigo-800 dark:selection:text-indigo-200 relative">
            ...
            <GlobalModalsContainer
                ...
                batchVocabInput={batchVocabInput}
                setBatchVocabInput={setBatchVocabInput}
