...
const SRSVocabScreen = ({
    ...
    const handleRating = (rating) => {
        ...
        // Thẻ có chu kỳ ngắn (1, 5, 10 phút) sẽ ở trạng thái chờ và được tự động chèn ngay sau thẻ hiện tại khi đúng thời gian hẹn
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" onClick={() => setShowSettingsMenu(false)}>
                        ...
                        <div className="relative bg-white dark:bg-slate-800 rounded-3xl shadow-2xl w-full max-w-sm p-6 space-y-4 border border-gray-200 dark:border-slate-700/80 animate-fade-in text-slate-850 dark:text-slate-200" onClick={e => e.stopPropagation()}>
                            ...
                            <div className="space-y-4 text-xs font-semibold text-slate-700 dark:text-slate-350">
                                ...
                                {cardSettings.reviewType === 'typing' ? (
                                    <div className="bg-indigo-50/80 dark:bg-indigo-950/40 border border-indigo-200/60 dark:border-indigo-800/60 rounded-2xl p-3.5 text-xs text-indigo-800 dark:text-indigo-300 leading-relaxed space-y-1.5">
                                        ...
                                        <p className="text-[11.5px] opacity-90">
                                            • <strong>Trước khi kiểm tra:</strong> Tự động hiển thị tinh gọn đúng từ câu hỏi (không làm lộ đáp án).
                                        </p>
                                        <p className="text-[11.5px] opacity-90">
                                            • <strong>Sau khi kiểm tra:</strong> Tự động mở khoá đầy đủ tất cả thông tin (cách đọc, cao độ, Hán Việt, câu ví dụ, từ đồng nghĩa, sắc thái).
                                        </p>
                                    </div>
                                ) : (
                                    <>
