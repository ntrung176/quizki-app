                ...
                <div className="bg-white dark:bg-slate-800 border border-slate-250 dark:border-slate-700 rounded-3xl p-6 space-y-4 shadow-sm w-full">
                    ...
                    <div className="border-t border-slate-200 dark:border-slate-700 pt-6 mt-6 space-y-4 w-full">
                        <h3 className="text-base font-bold text-slate-855 dark:text-white flex items-center gap-2">
                            <Layers className="w-5 h-5 text-emerald-500" /> Giao diện trực quan (Zen Visual Grammar)
                        </h3>
                ...
                <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 space-y-4 shadow-sm w-full">
                        ...
                        {showAiPromptGuide && (
                            <div className="space-y-3 pt-3 border-t border-slate-200 dark:border-slate-700/50 animate-fade-in">
                                ...
                                <div className="relative group">
                                    ...
                                    <button onClick={handleCopyAiPrompt} className="absolute top-2.5 right-2.5 px-3 py-1.5 bg-amber-500 hover:bg-amber-600 text-white font-bold text-xs rounded-lg shadow-md transition-all flex items-center gap-1 cursor-pointer">
                    ...
                    <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 space-y-3">
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full text-xs px-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl outline-none focus:border-emerald-500 font-sans"
                        />
                        <button
